...
class State:
    ...
    def __init__(self, board, predecessor, move):
        """ constructs a new State object by initializing the following 
            ...
            inputs: board is a Board object
                    predecessor is a reference to the State object 
                    that comes before this state
                    move is a string
        """
        # initializing board, predecessor, move, and num_moves
        self.board = board
    ...
    def generate_successors(self):
        ...
        """
        #initialize succesors list
        successors = []
        # go through 'up', 'down' ...  
        for m in MOVES:
            b = self.board.copy()
            # checls if move possible and does the move
